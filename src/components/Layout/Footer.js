...
const Github = ({ size = 20} = {}) => {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="white" stroke="black" strokeWidth="0.1" strokeLinecap="round" strokeLinejoin="round">
